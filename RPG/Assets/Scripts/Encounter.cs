...
namespace TextRPG
{
    public class Encounter : MonoBehaviour
    {
        ...
        public void Loot()
        {
            ...
            Journal.Instance.Log(string.Format("<color=#56FFC7FF>You've slain {0}. Searching the carcass, you find a {1} and {2} gold!</color>",this.Enemy.Description, this.Enemy.Inventory[0], this.Enemy.Gold));
            this.Enemy = null;
            player.Room.Enemy = null;
            player.Investigate();
            UIController.OnEnemyUpdate(this.Enemy);
